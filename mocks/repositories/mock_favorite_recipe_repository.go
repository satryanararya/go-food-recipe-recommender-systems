...
func (_m *MockFavoriteRecipeRepository) FindFavoritesByUserID(ctx context.Context, userID int64) ([]entities.FavoriteRecipe, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64) ([]entities.FavoriteRecipe, error)); ok {
		return rf(ctx, userID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64) []entities.FavoriteRecipe); ok {
		r0 = rf(ctx, userID)
	} else {
		if ret.Get(0) != nil {
...
func (_m *MockFavoriteRecipeRepository) RemoveFromFavorites(ctx context.Context, userID int64, recipeID int64) error {
