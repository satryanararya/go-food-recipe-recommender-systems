...
func (_m *MockRecommendationRepository) GetRecommendation(ctx context.Context, userID uuid.UUID) (*[]entities.Recommendation, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) (*[]entities.Recommendation, error)); ok {
		return rf(ctx, userID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) *[]entities.Recommendation); ok {
		r0 = rf(ctx, userID)
	} else {
		if ret.Get(0) != nil {
